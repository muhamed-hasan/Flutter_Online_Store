...
class KColorsConsts {
  ...
  static const Color title = Color(0xDD000000);
  static const Color subTitle = Color(0x8A000000);
  static const Color backgroundColor = Color(0xFFE0E0E0); //grey shade 300
  static const Color black = Color(0xFF000000);

  static const Color favColor = Color(0xFF3843FB); // red 500
  ...
  static const Color gradiendFStart = Color(0xFFE040FB); //purpleaccent 100
  static const Color gradiendFEnd = Color(0xFFE1BEE7); //purple 100
